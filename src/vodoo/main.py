...
def model_create(
    model: Annotated[str, typer.Argument(help="Model name (e.g., Julian Rath.template.registry)")],
    fields: Annotated[
        list[str],
    ...
    Examples:
        vodoo model create Julian Rath.template.registry name=my_template category=invoice
...
def model_read(
    ...
    Examples:
        ...
        vodoo model read Julian Rath.template.registry 42

        # Search records
        vodoo model read Julian Rath.template.registry --domain='[["category","=","invoice"]]'
...
def model_update(
    ...
    Examples:
        vodoo model update Julian Rath.template.registry 42 version=2.0.0 active=true
...
def model_delete(
    ...
    Examples:
        vodoo model delete Julian Rath.template.registry 42
    """
    client = get_client()
