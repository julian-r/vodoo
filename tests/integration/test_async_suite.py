...
class TestAsyncDocuments:
    """Test async folder discovery and a real upload/download with cleanup."""

    async def test_document_round_trip(
        self, async_client: AsyncOdooClient, odoo_version: int, tmp_path: Path
    ) -> None:
